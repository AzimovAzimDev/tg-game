...
const barStyle: React.CSSProperties = {
  ...
  right: 0,
  bottom: 0,
  height: 'calc(60px + var(--safe-area-inset-bottom, 18px))',
  paddingBottom: 'var(--safe-area-inset-bottom, 18px)',
  background: '#0f1a2b',
...
const fabStyle: React.CSSProperties = {
  position: 'fixed',
  left: '50%',
  bottom: 'calc(30px + var(--safe-area-inset-bottom, 18px))', // slightly out of tab bar
...
export default function TabBar() {
  ...
  const tabs: ({ to?: string; label: string; iconPath: string; onClick?: () => void; })[] = [
    ...
    { to: '/rules', label: t('tabs.rules'), iconPath: 'M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z' }, // Rules icon
    {
