...
export default function DeployGame() {
  ...
  useEffect(() => {
    ...
    const params = {
      ...
      fallSpeedMax: 580,
      fallRampPct: 0.06,
      blockSize: { w: 40, h: 40, stackCompression: 0.65 },
      platformWidth: 240,
      badEverySecMin: 12,
      maxActiveBlocks: 12,
  ...
  return (
    <div className="wrap">
      <main className="panel game" id="game" style={{ position: 'relative', overflow: 'hidden', paddingTop: 'calc(var(--safe-area-inset-top, 0px) + 50px)' }}>
